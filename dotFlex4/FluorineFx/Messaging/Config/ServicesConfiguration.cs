...
namespace dotFlex.Messaging.Config
{
    /// <summary>
    ...
    public sealed class ServiceDefinition
    {
        ...
        static AdapterDefinition DefaultRemotingAdapterDefinition = new AdapterDefinition("dotnet", typeof(dotFlex.Remoting.RemotingAdapter).FullName, true);
