...
using dotFlex.Messaging.Config;
...
namespace dotFlex.Messaging
{
    ...
    public class MessageBroker
	{
        ...
        /// </remarks>
        public dotFlex.Messaging.Api.IGlobalScope GlobalScope { get { return _globalScope; } }
        ...
        internal dotFlex.Messaging.Api.IClientRegistry ClientRegistry
        {
        ...
        internal dotFlex.Messaging.Api.IClient GetClient(string id)
        {
