...
namespace dotFlex.Messaging.Adapter
{
	...
	public abstract class AbstractScopeAdapter : IScopeHandler
	{
        ...
        /// <returns>true to allow, false to deny.</returns>
        public bool ServiceCall(IConnection connection, dotFlex.Messaging.Api.Service.IServiceCall call)
        {
		...
		public bool HandleEvent(dotFlex.Messaging.Api.Event.IEvent evt)
		{
