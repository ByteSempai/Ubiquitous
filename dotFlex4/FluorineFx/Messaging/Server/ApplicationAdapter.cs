...
using dotFlex.Messaging.Rtmp.IO;
using dotFlex.Messaging.Server;
using dotFlex.Exceptions;
using dotFlex.Util;
using dotFlex.Context;

namespace dotFlex.Messaging.Adapter
{
	/// <summary>
    /// <para>
    ...
    public class ApplicationAdapter : StatefulScopeWrappingAdapter, ISharedObjectService, ISharedObjectSecurityService, IStreamSecurityService
	{
        ...
        protected void InvokeClients(string method, object[] arguments, IPendingServiceCallback callback, bool ignoreSelf, IScope targetScope)
        {
            try
            {
                ...
                IServiceCapableConnection connection = dotFlex.Context.FluorineContext.Current.Connection as IServiceCapableConnection;
        ...
        {
            CalculateClientBw(dotFlex.Context.FluorineContext.Current.Connection);
        }
        /// <summary>
        /// Start a bandwidth check.
        /// </summary>
