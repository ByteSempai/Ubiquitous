...
using dotFlex.Messaging.Api.Messaging;
using dotFlex.Messaging.Api.Stream;
using dotFlex.Messaging.Api.Statistics;
using dotFlex.Messaging.Api.Event;
using dotFlex.Messaging.Rtmp.Messaging;
using dotFlex.Messaging.Rtmp.Event;
using dotFlex.Messaging.Rtmp.Stream;
using dotFlex.Messaging.Rtmp.Stream.Codec;
using dotFlex.Messaging.Rtmp.Stream.Consumer;
using dotFlex.Messaging.Rtmp.Stream.Messages;
using dotFlex.Messaging.Messages;
using dotFlex.Collections;

namespace dotFlex.Messaging.Rtmp.Stream
{
    /// <summary>
        ...
        IClientBroadcastStream, IFilter, IPushableConsumer, IPipeConnectionListener, IEventDispatcher, IClientBroadcastStreamStatistics
    {
        ...
        public void StartPublishing()
        {
            ...
            SendStartNotifications(dotFlex.Context.FluorineContext.Current.Connection);
        }
        ...
        public void DispatchEvent(IEvent evt)
        {
            ...
            dotFlex.Messaging.Rtmp.Stream.Messages.RtmpMessage msg = new dotFlex.Messaging.Rtmp.Stream.Messages.RtmpMessage();
            msg.body = rtmpEvent;
