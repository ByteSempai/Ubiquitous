...
namespace dotFlex.Messaging
{
    ...
    public abstract class BaseConnection : AttributeStore, IConnection
    {
        ...
        */
        ...
        public virtual void DispatchEvent(dotFlex.Messaging.Api.Event.IEvent evt)
        {
        }
        ...
        public virtual bool HandleEvent(dotFlex.Messaging.Api.Event.IEvent evt)
        {
        ...
        /// </summary>
        /// <param name="evt">Event.</param>
        public virtual void NotifyEvent(dotFlex.Messaging.Api.Event.IEvent evt)
        {
        }
