	...
	public class AMFDeserializer : AMFReader
	{
        ...
        private ErrorResponseBody GetErrorBody(AMFBody amfBody, Exception exception)
        {
            ...
            try
            {
                ...
                if (content is dotFlex.Messaging.Messages.IMessage)
                    errorResponseBody = new ErrorResponseBody(amfBody, content as dotFlex.Messaging.Messages.IMessage, exception);
                else
