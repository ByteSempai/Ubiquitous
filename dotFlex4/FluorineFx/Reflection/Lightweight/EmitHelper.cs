...
namespace dotFlex.Reflection.Lightweight
{
	/// <summary>
	...
	class EmitHelper
	{
        ...
        */
        ...
        {
            ConstructorInfo exceptionConstructor = typeof(dotFlex.Exceptions.UnexpectedAMF).GetConstructor(AnyVisibilityInstance, null, CallingConventions.HasThis, new Type[] { typeof(string) }, null);
        ...
        {
            MethodInfo miFluorineConfigurationGetInstance = typeof(dotFlex.Configuration.FluorineConfiguration).GetMethod("get_Instance");
            MethodInfo miFluorineConfigurationGetNullableValues = typeof(dotFlex.Configuration.FluorineConfiguration).GetMethod("get_NullableValues");
            MethodInfo miTypeGetTypeFromHandle = typeof(Type).GetMethod("GetTypeFromHandle");
            MethodInfo miNullableTypeCollectionGetItem = typeof(dotFlex.Configuration.NullableTypeCollection).GetMethod("get_Item", new Type[] { typeof(Type) });
