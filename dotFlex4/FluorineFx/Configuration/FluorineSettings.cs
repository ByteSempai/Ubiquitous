...
#if !FXCLIENT
using dotFlex.HttpCompress;
#endif
#if !(NET_1_1)
using System.Collections.Generic;
using dotFlex.Collections.Generic;
#endif

namespace dotFlex.Configuration
{
	/// <summary>
...
#endif
    {
		...
		{
			Add(typeof(dotFlex.AMF3.ArrayCollection).FullName, "flex.messaging.io.ArrayCollection");
			Add(typeof(dotFlex.AMF3.ByteArray).FullName, "flex.messaging.io.ByteArray");
			Add(typeof(dotFlex.AMF3.ObjectProxy).FullName, "flex.messaging.io.ObjectProxy");

			Add(typeof(dotFlex.Messaging.Messages.CommandMessage).FullName, "flex.messaging.messages.CommandMessage");
			Add(typeof(dotFlex.Messaging.Messages.RemotingMessage).FullName, "flex.messaging.messages.RemotingMessage");
			Add(typeof(dotFlex.Messaging.Messages.AsyncMessage).FullName, "flex.messaging.messages.AsyncMessage");
			Add(typeof(dotFlex.Messaging.Messages.AcknowledgeMessage).FullName, "flex.messaging.messages.AcknowledgeMessage");
            Add(typeof(dotFlex.Messaging.Messages.ErrorMessage).FullName, "flex.messaging.messages.ErrorMessage");
			//Add(typeof(FluorineFx.Messaging.Messages.RPCMessage).FullName, "flex.messaging.messages.RPCMessage");			
			
#if !FXCLIENT
			Add(typeof(dotFlex.Data.Messages.DataMessage).FullName, "flex.data.messages.DataMessage");
			Add(typeof(dotFlex.Data.Messages.PagedMessage).FullName, "flex.data.messages.PagedMessage");
			Add(typeof(dotFlex.Data.Messages.UpdateCollectionMessage).FullName, "flex.data.messages.UpdateCollectionMessage");
			Add(typeof(dotFlex.Data.Messages.SequencedMessage).FullName, "flex.data.messages.SequencedMessage");
            Add(typeof(dotFlex.Data.Messages.DataErrorMessage).FullName, "flex.data.messages.DataErrorMessage");
			Add(typeof(dotFlex.Data.UpdateCollectionRange).FullName, "flex.data.UpdateCollectionRange");			

            Add(typeof(dotFlex.Messaging.Services.RemotingService).FullName, "flex.messaging.services.RemotingService");
			Add(typeof(dotFlex.Messaging.Services.MessageService).FullName, "flex.messaging.services.MessageService");
			Add(typeof(dotFlex.Data.DataService).FullName, "flex.data.DataService");
            Add(typeof(dotFlex.Messaging.Endpoints.RtmpEndpoint).FullName, "flex.messaging.endpoints.RTMPEndpoint");
            Add(typeof(dotFlex.Messaging.Endpoints.AMFEndpoint).FullName, "flex.messaging.endpoints.AMFEndpoint");
            Add(typeof(dotFlex.Messaging.Endpoints.StreamingAmfEndpoint).FullName, "flex.messaging.endpoints.StreamingAMFEndpoint");
            Add(typeof(dotFlex.Messaging.Endpoints.SecureAmfEndpoint).FullName, "flex.messaging.endpoints.SecureAMFEndpoint");
            Add(typeof(dotFlex.Messaging.Endpoints.SecureRtmpEndpoint).FullName, "flex.messaging.endpoints.SecureRTMPEndpoint");
			Add(typeof(dotFlex.DotNetAdapter).FullName, "flex.messaging.services.remoting.adapters.JavaAdapter");
#endif
        }
        /// <summary>
        /// This member supports the Fluorine infrastructure and is not intended to be used directly from your code.
    ...
    public class StreamableFileFactorySettings
    {
        ...
        {
            _type = typeof(dotFlex.Messaging.Rtmp.IO.StreamableFileFactory).FullName;
        }
    ...
    public class BWControlServiceSettings
    {
        ...
        {
            _type = typeof(dotFlex.Messaging.Rtmp.Stream.DummyBWControlService).FullName;
            _interval = 100;
    ...
    public class SchedulingServiceSettings
    {
        ...
        {
            _type = typeof(dotFlex.Scheduling.SchedulingService).FullName;
        }
        /// <summary>
        /// This member supports the Fluorine infrastructure and is not intended to be used directly from your code.
        /// </summary>
    ...
    public sealed class RuntimeSettings
    {
        ...
        {
            _asyncHandler = false;
            _minWorkerThreads = dotFlex.Threading.ThreadPoolEx.DefaultMinWorkerThreads;
            _maxWorkerThreads = dotFlex.Threading.ThreadPoolEx.DefaultMaxWorkerThreads;
        }
        /// <summary>
        /// This member supports the Fluorine infrastructure and is not intended to be used directly from your code.
        /// </summary>
