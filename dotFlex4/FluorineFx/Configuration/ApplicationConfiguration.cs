    ...
    public class ApplicationHandlerConfiguration : ConfigurationSection
    {
        ...
        public string Type
        {
            ...
            { 
                if( _type != null )
                    return _type;
                return typeof(dotFlex.Messaging.Adapter.ApplicationAdapter).FullName;
            }
            set { _type = value; }
        }
    ...
    public class StreamFilenameGeneratorConfiguration : ConfigurationSection
    {
        ...
        public string Type
        {
            get
            {
                if (_type != null)
                    return _type;
                return typeof(dotFlex.Messaging.Rtmp.Stream.DefaultStreamFilenameGenerator).FullName;
            }
            set { _type = value; }
        }
    }
    ...
    public class SharedObjectServiceConfiguration : ConfigurationSection
    {
        ...
        public string Type
        {
            get
            {
                if (_type != null)
                    return _type;
                return typeof(dotFlex.Messaging.Rtmp.SO.SharedObjectService).FullName;
            }
            set { _type = value; }
        }
    ...
    public class PersistenceStoreConfiguration
    {
        ...
        public string Type
        {
            get
            {
                if (_type != null)
                    return _type;
                return typeof(dotFlex.Messaging.Rtmp.Persistence.MemoryStore).FullName;
            }
            set { _type = value; }
        }
    }
    ...
    public class ProviderServiceConfiguration : ConfigurationSection
    {
        ...
        public string Type
        {
            get
            {
                if (_type != null)
                    return _type;
                return typeof(dotFlex.Messaging.Rtmp.Stream.ProviderService).FullName;
            }
            set { _type = value; }
        }
    }
    ...
    public class ConsumerServiceConfiguration : ConfigurationSection
    {
        ...
        public string Type
        {
            get
            {
                if (_type != null)
                    return _type;
                return typeof(dotFlex.Messaging.Rtmp.Stream.ConsumerService).FullName;
            }
            set { _type = value; }
        }
    }
    ...
    public class StreamServiceConfiguration : ConfigurationSection
    {
        ...
        public string Type
        {
            get
            {
                if (_type != null)
                    return _type;
                return typeof(dotFlex.Messaging.Rtmp.Stream.StreamService).FullName;
            }
            set { _type = value; }
        }
    }
